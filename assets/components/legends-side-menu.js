(() => {
  ...
  class LegendsSideMenu extends HTMLElement {
      ...
      this.innerHTML = `
        ...
        <aside id="moreMenu" class="legends-side-menu__drawer" aria-label="Menu principal" aria-hidden="true">
          ...
          <nav class="legends-side-menu__nav" aria-label="Menu principal">
            ...
            <button id="importMenuBtn" class="legends-side-menu__item" type="button" aria-expanded="false" aria-controls="importSubmenu"><span class="legends-side-menu__item-icon" aria-hidden="true">⇧</span><span class="legends-side-menu__item-label">Importar</span><span aria-hidden="true">⌄</span></button>
            <div id="importSubmenu" class="legends-side-menu__submenu" hidden><button id="menuImportExcelBtn" class="legends-side-menu__item" type="button">Importar Excel</button><button id="menuImportJsonBtn" class="legends-side-menu__item" type="button">Importar backup JSON</button><button id="menuImportTextBtn" class="legends-side-menu__item" type="button">Importar lista de nomes</button></div>
            ...
            <div id="exportSubmenu" class="legends-side-menu__submenu" hidden><button id="exportPdfBtn" class="legends-side-menu__item" type="button">Exportar súmula em PDF</button><button id="exportExcelBtn" class="legends-side-menu__item" type="button">Exportar para Excel</button><button id="exportJsonBtn" class="legends-side-menu__item" type="button">Exportar backup JSON</button></div>
            <div class="legends-side-menu__divider" aria-hidden="true"></div>
    ...
    closeMenu() { this.removeAttribute('data-open');this.querySelector('#moreMenuBtn').setAttribute('aria-expanded','false');this.querySelector('#moreMenu').setAttribute('aria-hidden','true');this.querySelector('#importSubmenu').hidden=true;this.querySelector('#importMenuBtn').setAttribute('aria-expanded','false');this.querySelector('#exportSubmenu').hidden=true;this.querySelector('#exportMenuBtn').setAttribute('aria-expanded','false');document.body.style.overflow=''; }
